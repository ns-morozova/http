...
var v1 = __webpack_require__(1033);
var v4 = __webpack_require__(2550);
...
;// CONCATENATED MODULE: ./src/js/queryDB.js
...
var queryDB = /*#__PURE__*/function () {
  function queryDB() {
    _classCallCheck(this, queryDB);
  }
  return _createClass(queryDB, null, [{
    key: "query",
    value: function () {
      var _query = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, param) {
        var objData,
          strParam,
          key,
          options,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              objData = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
              strParam = '';
              for (key in param) {
                if (strParam == '') {
              ...
              _context.next = 9;
              return fetch(this.URL + strParam, options);
            case 9:
...
_defineProperty(queryDB, "URL", 'http://127.0.0.1:7070');
...
var uuid = __webpack_require__(8414);
var Modal = /*#__PURE__*/function () {
  function Modal(type) {
    ...
    if (this.type < 3) {
      this.form.innerHTML = "\n                <div class=\"form-popup\">\n                    <span class=\"head-add\">".concat(descr, "</span>\n                    <div class=\"form-descr\">\n                        <label for=\"descr-short-add\">\u041A\u0440\u0430\u0442\u043A\u043E\u0435 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</label>\n                        <textarea id=\"descr-short-add\" class=\"descr-ticket\" name=\"descr-short\">").concat(name, "</textarea>\n                        <label for=\"descr-detail-add\">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u043E\u0435 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0435</label>\n                        <textarea id=\"descr-detail-add\" class=\"descr-ticket\" name=\"descr-detail\">").concat(description, "</textarea>\n                    </div>\n                    <div class=\"form-btn\">\n                        <button class=\"btn-popup btn-cancel\">\u041E\u0442\u043C\u0435\u043D\u0430</button>\n                        <button class=\"btn-popup btn-ok\">\u041E\u043A</button>\n                    </div>\n                </div>\n                ");
    } else {
  ...
  return Modal_createClass(Modal, [{
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", new Promise(function (resolve) {
                _this.form.addEventListener('close', function (event) {
                  resolve({
                    'status': 'OK',
                    'data': event.detail
                  });
    ...
    key: "onClickOk",
    value: function onClickOk(event) {
      event.preventDefault();
      var data = {
...
function Ticket_typeof(o) { "@babel/helpers - typeof"; return Ticket_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, Ticket_typeof(o); }
...
function Ticket_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function Ticket_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Ticket_toPropertyKey(descriptor.key), descriptor); } }
function Ticket_createClass(Constructor, protoProps, staticProps) { if (protoProps) Ticket_defineProperties(Constructor.prototype, protoProps); if (staticProps) Ticket_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function Ticket_toPropertyKey(t) { var i = Ticket_toPrimitive(t, "string"); return "symbol" == Ticket_typeof(i) ? i : i + ""; }
function Ticket_toPrimitive(t, r) { if ("object" != Ticket_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != Ticket_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }

var Ticket = /*#__PURE__*/function () {
  function Ticket(element) {
    Ticket_classCallCheck(this, Ticket);
    this.ticket = element;
  ...
  return Ticket_createClass(Ticket, [{
    key: "onClickEdit",
    value: function onClickEdit(event) {
      event.preventDefault();
      this.ticket.dispatchEvent(new CustomEvent('edit', {
        'bubbles': true,
    ...
    value: function onClickDelete(event) {
      event.preventDefault();
      this.ticket.dispatchEvent(new CustomEvent('delete', {
        'bubbles': true,
        'detail': this.ticket.id
      }));
    }
    ...
    key: "onClickTicket",
    value: function onClickTicket(event) {
      event.preventDefault();
      if (event.target.classList.contains('icon-edit') || event.target.classList.contains('icon-delete') || event.target.closest('.inp-check')) {
        return;
      }
      var descr = this.ticket.querySelector('.descr');
      descr.classList.toggle('hidden');
    }
  }, {
    key: "onClickChecked",
    value: function onClickChecked(event) {
      event.preventDefault();
      var check = event.target.closest('.inp-check');
      var imgCheck = check.querySelector('.img-check');
      imgCheck.classList.toggle('hidden');
      var checked = !imgCheck.classList.contains('hidden');
      queryDB.query('GET', {
        'method': 'ticketById',
        'id': this.ticket.id
...
function Controller_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, Controller_toPropertyKey(descriptor.key), descriptor); } }
...
var Controller = /*#__PURE__*/function () {
  ...
  return Controller_createClass(Controller, [{
    ...
    value: function init() {
      var _this = this;
      var btn = document.querySelector('.ticket-add');
      ...
      queryDB.query('GET', {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var objTicket = _step.value;
            _this.addTiket(objTicket);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
    ...
    key: "addTiket",
    value: function addTiket(objTicket) {
      var ticket = document.createElement('div');
      ticket.id = objTicket.id;
      ticket.classList.add('ticket');
      ticket.innerHTML = "\n                    <div class=\"task\">\n                            <div class=\"inp-check\">\n                                 <img class=\"img-check ".concat(objTicket.checked ? '' : 'hidden', "\" src=\"checkmark_0btrup04y0p6.svg\" width=\"14\" height=\"14\">\n                            </div>\n                            <div class=\"descrs\">\n                                <span class=\"descr-short\">").concat(objTicket.name, "</span> \n                                <span class=\"descr hidden\">").concat(objTicket.description, "</span>\n                            </div>    \n                    </div>\n\n                    <div class=\"info\">\n                        <span>").concat(this.getFormatData(objTicket.created), "</span>\n                        <div class=\"icons\">\n                            <img class=\"icon icon-edit\" src=\"pencil_ctfnc1wpi1j0.svg\" width=\"10\" height=\"10\" alt=\"correct\">\n                            <img class=\"icon icon-delete\" src=\"close_14xpqtqf4d7h.svg\" width=\"10\" height=\"10\" alt=\"close\">\n                        </div>\n                    </div>\n                ");
      ticket.id = objTicket.id;
      document.querySelector('.tickets').append(ticket);
      this.tickets.push(new Ticket(ticket));
    }
  }, {
    key: "onClickAddTicket",
    value: function onClickAddTicket(event) {
      var _this2 = this;
      event.preventDefault();
      var modal = new Modal(1);
      var promise = modal.show();
      promise.then(function (resolve) {
        var objData = resolve.data;
        if (!objData) {
          return;
        }
        var date = new Date();
        ...
        queryDB.query('POST', {
          ...
          if (response.status == 200) {
            _this2.addTiket(objData);
          }
        });
      });
    }
  }, {
    key: "onClickCancelAdd",
    value: function onClickCancelAdd(event) {
      event.preventDefault();
    }
  }, {
    key: "onClickOkAdd",
    value: function onClickOkAdd(event) {
      event.preventDefault();
    }
  }, {
    key: "onClickEdit",
    value: function onClickEdit(event) {
      ...
      queryDB.query('GET', {
        ...
        if (response.status == 200) {
          var modal = new Modal(2, response.data);
          var promise = modal.show();
          promise.then(function (resolve) {
            var objData = resolve.data;
            if (!objData) {
            ...
            queryDB.query('POST', {
              ...
              if (response.status == 200) {
                var ticket = _this3.container.querySelector("[id=\"".concat(objData.id, "\"]"));
                var label = ticket.querySelector('.descr-short');
    ...
    value: function onClickDelete(event) {
      ...
      queryDB.query('GET', {
        ...
        if (response.status == 200) {
          var modal = new Modal(3, response.data);
          var promise = modal.show();
          promise.then(function (resolve) {
            var objData = resolve.data;
            if (!objData) {
            ...
            queryDB.query('DELETE', {
              'method': 'deleteById',
              'id': objData.id
            }).then(function (response) {
              if (response.status == 200) {
                var ticket = _this4.container.querySelector("[id=\"".concat(event.detail, "\"]"));
                var tickArr = _this4.tickets.find(function (elem) {
                  return elem == ticket;
                });
                _this4.tickets.splice(_this4.tickets.indexOf(tickArr), 1);
                ticket.remove();
              }
            });
          });
    ...
    key: "getFormatData",
    value: function getFormatData(timestamp) {
...
var ctrl = new Controller(document.querySelector('.container'));
ctrl.init();
